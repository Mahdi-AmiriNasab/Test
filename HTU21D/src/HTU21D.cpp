...
/*
    ...
    sends the device's address and HAL status returns
	NOTE:
	- timeout is 100ms
/**************************************************************************/
bool bus::beginTransmission(uint8_t slave_add)
{
	HAL_StatusTypeDef status;
	status = I2C_MasterRequestWrite(&HTU_I2C, slave_add, 100, tickstart);
	return status;	
}
